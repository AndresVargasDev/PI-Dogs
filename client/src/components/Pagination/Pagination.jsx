...
const Pagination = ({ firstHandler, prevHandler, nextHandler, lastHandler, pagination, totalDogs, dogsPerPage }) => {
    ...
    return (
        <div className={style.buttons}>
            ...
            {
                numOfPages?.map((page) => {
                    return <button className={style.pageButton} id={page} key={page} onClick={() => pagination(page)}>{page + 1}
                    </button>
                })
            }
